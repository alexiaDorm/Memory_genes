...
def objective(trial):
    ...
    charac_out_path = '../data/Characteristics_masterfiles/Dataset_specific_characteristics/LK_LSK_D2_exp3_library_d2_3__characteristics_output.txt'
    p_value_path = '../data/Characteristics_masterfiles/Memory_genes/P_value_estimate_CV2_ofmeans_LK_LSK_D2_exp3_library_d2_3.txt'
